...
10. **طبّق سكِيل `karpathy-guidelines`** قبل أي كتابة/تعديل/إعادة هيكلة للكود: أظهِر الافتراضات واسأل عند الغموض · أقل كود يحلّ المشكلة بلا تجريد أو «مرونة» غير مطلوبة · تعديلات جراحية (المس فقط ما يلزم، لا «تحسين» كود مجاور سليم) · حوِّل المهمة لمعيار نجاح قابل للتحقّق (اختبار يمرق). للمهام التافهة استعمل الحكم.
