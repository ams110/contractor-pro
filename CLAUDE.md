...
10. **سجّل النواقص دائماً** — كل جلسة تُنهي عملاً غير مكتمل (blocker، نصف ميزة، دَين تقني، مهمة تسويق مؤجّلة) تُضيفه لـ`docs/NAWAQIS.md` قبل ما تخلص، وتشطب المكتمل بـ✅ مع تاريخه.
