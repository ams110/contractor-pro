...
| `contractor-pro-story-haj-day.mp4` | 🆕 **قصة «يوم بحياة الحاج»** · ~34s · حبكة من الصبح للمسا (سلفة→مصروف→تحصيل→ربح). ٤ مشاهد حاج بهوية ثابتة (`seedance_2_0`) + ٤ شاشات حقيقية + VO سردي + موسيقى. سرد قصصي مش شهادة واقفة. **تصدير نظيف.** الخطّ: `scripts/cards-day.mjs` + `build-day.sh`. |
| `contractor-pro-pain-accountant.mp4` | 🆕 **أرخص من محاسب** · ~20s · مقارنة ₪1,800 vs ₪990 + شاشات. زاوية سعر/قيمة. الخطّ: `scripts/cards-batch.mjs` + `build-batch.sh`. |
| `contractor-pro-worker-pov.mp4` | 🆕 **بوّابة العامل — بصوت العامل** · ~19s · منظور العامل (مش المالك) + شاشات. **تصدير نظيف.** |
| `contractor-pro-offline.mp4` | 🆕 **يشتغل بلا نت** · ~14s · b-roll موقع + شاشة (offline/PWA). **تصدير نظيف.** |
| `contractor-pro-vat18.mp4` | 🆕 **מע"מ 18%** · ~12s · بطاقة رقم حادّة + شاشة مصاريف. للمدفوع/A-B. **تصدير نظيف.** |
