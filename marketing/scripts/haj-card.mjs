...
<div style="position:absolute;bottom:300px;inset-inline-start:64px;display:flex;align-items:center;gap:16px;
  ...
  <div style="width:12px;height:64px;border-radius:6px;background:${GRAD_BRAND}"></div>
  <div>
    <div style="font-family:'Noto Kufi Arabic';font-weight:900;font-size:46px;letter-spacing:-0.02em;line-height:1">الحاج أبو محمود</div>
    <div style="font-size:30px;color:#CBD5E1;font-weight:600;margin-top:6px">مقاول · ٣٠ سنة خبرة</div>
  </div>
</div></body></html>`
...
await page.screenshot({ path: resolve(OUT, 'haj-overlay.png'), omitBackground: true })
console.log('✅ haj-overlay.png'); await browser.close()
