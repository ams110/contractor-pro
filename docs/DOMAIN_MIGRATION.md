...
> 🧪 **بصمة ثالثة مؤقّتة لـ`com.kabblan.app`** — `17:EB:65:33:…:F9:70` — تخصّ مفتاحاً
> **مولَّداً محلياً** لبناء نسخة APK تجريبية للمالك (مفتاح الرفع الرسمي محفوظ كسرّ
> `ANDROID_KEYSTORE_BASE64` وغير متاح خارج الـworkflow). وجودها يجعل نسخة التجربة
> تعمل **ملء الشاشة** بدل أن تُفتح داخل تبويب متصفّح.
> 🔴 **احذفها بعد انتهاء التجربة** — هي تمنح مفتاحاً غير رسمي صلاحية تمثيل النطاق.
> لا علاقة لها بنسخة المتجر إطلاقاً (Play يوقّع بمفتاحه الخاص).
