...
-- =====================================================
--
-- ⚠️ تنبيه: هذا الملف لقطة أوّليّة (bootstrap) وقد لا يعكس المخطط الحالي
--    بدقّة. المرجع المعتمد للمخطط الفعلي هو:
--      1. قاعدة البيانات الحيّة على Supabase (المصدر الموثوق)
--      2. ملفات supabase/migrations/  (التغييرات التراكمية بعد هذا الملف)
--    مثال على الانحراف: أعمدة business_id على client_receipts/expenses
--    و project_id على advances أُضيفت عبر migrations وليست هنا.
--    قبل أي تعديل على المخطط راجع الجداول الفعلية، لا تعتمد على هذا الملف.
-- =====================================================
