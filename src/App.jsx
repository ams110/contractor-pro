...
export default function App() {
  ...
  function renderScreen() {
    ...
    switch (screen) {
      ...
      case 'expenses':  return p.viewExpenses  ? <ExpensesScreen  expenses={expenses} projects={projects} expCats={expCats} addExpense={addExpense} deleteExpense={deleteExpense} approveExpense={approveExpense} rejectExpense={rejectExpense} employees={employees} userId={uid} permissions={p} businessType={businessType} /> : <NoAccess />
