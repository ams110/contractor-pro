...
export default function App() {
  ...
  const { projects,       loading: pLoad,  addProject,    updateProject,    deleteProject, archiveProject, restoreProject } = useProjects(eid)
  ...
  function renderScreen() {
    ...
    switch (screen) {
      ...
      case 'projects':   content = p?.viewProjects  ? <ProjectsScreen  {...allData} addProject={addProject} updateProject={updateProject} deleteProject={deleteProject} archiveProject={archiveProject} addReceipt={addReceipt} updateReceipt={updateReceipt} deleteReceipt={deleteReceipt} addWorkDay={addWorkDay} bulkAddWorkDays={bulkAddWorkDays} updateWorkDay={updateWorkDay} deleteWorkDay={deleteWorkDay} approveWorkDay={_approveWorkDay} rejectWorkDay={_rejectWorkDay} addExpense={addExpense} deleteExpense={deleteExpense} expCats={expCats} userId={uid} permissions={p} payMethods={payMethods} holidays={holidays} /> : <NoAccess />; break
