...
export default function App() {
  ...
  function renderScreen() {
    ...
    switch (screen) {
      ...
      case 'accounting':  content = p.viewExpenses ? <AccountingScreen projects={visibleProjects} employees={visibleEmployees} expenses={visibleExpenses} payments={visiblePayments} clientReceipts={visibleClientReceipts} taxAdvances={taxAdvances} /> : <NoAccess />; break
