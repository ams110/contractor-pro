...
export default function App() {
  ...
  const { specs, expCats, payMethods, pensionMonthly, taxEnabled, taxModules, addSpec, removeSpec, addExpCat, removeExpCat, addPayMethod, removePayMethod, setPensionMonthly, setTaxEnabled, setTaxModule } = useSettings(eid)
