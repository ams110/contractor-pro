...
function OwnerApp() {
  ...
  function renderScreen() {
    ...
    switch (screen) {
      case 'dashboard':  content = <DashboardScreen {...allData} onNav={setScreen} permissions={p} addAdvance={addAdvance} />; break
      ...
      default:           content = <DashboardScreen {...allData} onNav={setScreen} permissions={p} addAdvance={addAdvance} />
    }
