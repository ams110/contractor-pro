...
const IDEAS_HE = [
  ...
  // 9 · مسح الإيصال OCR (وعد الحل بعد هوك الضياع) · شاشة المصاريف
  { tag: 'סריקת חשבוניות', tone: 'brand', screen: 'expenses',
    kw: 'אף חשבונית', head: 'לא הולכת לאיבוד.',
    sub: 'מצלמים את החשבונית — והמערכת קוראת לבד סכום, ספק, תאריך וקטגוריה. הכול שמור, מתויק ומוכן לדוח המע"מ.' },
]
