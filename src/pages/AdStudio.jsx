...
const IDEAS_HE = [
  ...
  // 10 · الذمّة الصافية (فضول + سيطرة) · بطاقة ההון הנקי بالداشبورد
  { tag: 'ההון הנקי', tone: 'success', screen: 'dashboard', focus: 'ההון הנקי',
  ...
  // 11 · عدّاد الضريبة (تخطيط مسبق — لا مفاجآت) · بطاقة מד המס بالداشبورد
  { tag: 'מד המס', tone: 'brand', screen: 'dashboard', focus: 'מד המס',
    kw: 'כמה מס תשלם', head: 'בסוף השנה?',
    sub: 'כבלאן צופה את ההכנסה השנתית שלך ומחשב מראש את המע"מ ומס ההכנסה — כדי שתשים בצד עכשיו, ולא תחטוף מכתב בסוף השנה.' },
]
