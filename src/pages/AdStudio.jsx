...
const IDEAS = [
  ...
  // ── زوايا محاكاة 07/07/2026 (docs/simulations/ad-format-decision-2026-07-07.md) ──
  // 38 · السولو/باقة معلّم — ثلث العيّنة (עוסק פטור لحالهم) حسّوا الإعلانات «مش إلهم»
  { tag: 'باقة معلّم', tone: 'gold', screen: 'expenses',
    kw: 'شغال لحالك؟', head: 'في باقة على قدّك',
    sub: 'باقة «معلّم» بـ35 شيكل بالشهر: صوّر إيصالك بالكاميرا، رتّب مدخولك ومصاريفك، وتنبيه قبل ما توصل سقف העוסק הפטור — بلا دفاتر وبلا وجع راس.',
    blocks: [{ type: 'header', title: 'مصروف جديد' }, { type: 'receipt' }] },

  // 39 · تقرير جاهز للمحاسب — بيحيّد الاعتراض #1 بالمحاكاة («المحاسب ضايل، يعني بدفع للاثنين؟»)
  { tag: 'وفّر من فاتورة المحاسب', tone: 'premium', screen: 'dashboard', focus: 'مدرج',
    kw: 'تقرير מע"מ جاهز', head: 'ابعثه لمحاسبك بضغطة',
    sub: 'بدل ما تسلّم محاسبك كرتونة فواتير آخر الشهر — كبلان بيصنّف كل شي أول بأول ويطلّعلك تقرير جاهز. شغل أقل عالمحاسب = فاتورة أقل عليك.',
    blocks: [{ type: 'header', title: 'ملخّص الضرائب' }, { type: 'heroMoney', icon: Calculator, label: 'מע"מ مستحق — محسوب ومصنّف', value: DEMO.vat, tone: 'premium', sub: 'تقرير جاهز للمحاسب' }, { type: 'insights', rows: [{ icon: CheckCircle2, color: C.success, text: 'كل فاتورة مصنّفة أول بأول' }, { icon: PiggyBank, color: C.cyan, text: 'شغل أقل للمحاسب — فاتورة أقل عليك' }] }] },
]
...
const IDEAS_HE = [
  ...
  // 3 · مע"מ 18% (سلطة + خوف) — محرّك الضرائب الإسرائيلي · شاشة المصاريف
