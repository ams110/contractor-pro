...
const IDEAS = [
  ...
  // 38 · AD-012 (خطة يوليو 2026) — الحاسبة بإطار الخسارة الصافية · شاشة الرواتب (إضافي محسوب)
  { tag: 'حساب الراتب', tone: 'gold', kw: 'غلطة وحدة بالحساب', head: '= آلاف بالسنة', sub: 'الإضافي 125% و150% محسوب حسب القانون — التطبيق بيطلّعلك الرقم الصح بثواني، بلا ولا غلطة.',
    blocks: [{ type: 'header', title: 'راتب العامل' }, { type: 'heroMoney', icon: HandCoins, label: 'المستحق (مع الإضافي)', value: 11550, tone: 'gold' }, { type: 'insights', rows: [{ icon: CheckCircle2, color: C.success, text: 'الساعات الإضافية محسوبة حسب القانون' }, { icon: Sparkles, color: C.cyan, text: 'يوميات ناقص سلف = صافي دقيق' }] }] },
]
...
const IDEAS_HE = [
  ...
  // 9 · AD-015 (خطة يوليو 2026) — خناقة الساعات آخر الشهر · شاشة العمّال (الإضافي المحسوب)
  { tag: 'ויכוח סוף החודש', tone: 'gold', screen: 'workers',
    kw: '12,400 או 11,600?', head: 'מי צודק?',
    sub: 'כל יום נרשם מהשטח, שעות נוספות מחושבות לפי חוק — 125% ו-150%. מספר אחד, בלי ויכוחים בסוף החודש.' },
]
...
const SCREEN_MAP = [
  ...
  { s: 'payments' },                        // 38 AD-012 الحاسبة (الرواتب مع الإضافي)
]
