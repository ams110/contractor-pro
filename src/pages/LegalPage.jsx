  ...
  privacy: {
    ...
    sections: [
      ...
      { h: '7. ملفّات تعريف الارتباط (Cookies)', p: [
        ...
        'بموافقتك، نستخدم Google Analytics لقياس استخدام الموقع وتحسينه (مع إخفاء عنوان الـIP). لا تُحمَّل هذه الأداة إلا بعد ضغطك «موافق» على لافتة الكوكيز، ويمكنك رفضها دون التأثير على عمل التطبيق.',
      ]},
      { h: '8. التواصل', p: [
