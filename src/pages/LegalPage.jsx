...
import { HardHat, ArrowRight, Mail, MessageCircle, Shield, FileText, RotateCcw, Trash2 } from 'lucide-react'
...
'نستخدم Google Analytics لقياس استخدام الموقع وتحسينه (مع إخفاء عنوان الـIP). نعتمد وضع الموافقة (Consent Mode): لا تُفعَّل كوكيز التحليلات إلا بعد ضغطك «موافق» على لافتة الكوكيز، وإذا رفضت لا تُحفظ أي كوكيز تحليلات. لا يؤثّر اختيارك على عمل التطبيق.',
  ...
  'delete-account': {
    icon: Trash2, title: 'حذف الحساب والبيانات',
    sections: [
      { h: '1. عن هذا الطلب', p: [
        `توضّح هذه الصفحة كيف تطلب حذف حسابك في تطبيق ${E.product} (المُشغّل من قِبل ${E.company}، عبر ${E.domain}) وكل البيانات المرتبطة به نهائياً.`,
      ]},
      { h: '2. الحذف الفوري من داخل التطبيق', p: [
        'افتح التطبيق وسجّل الدخول بحسابك.',
        'اذهب إلى: الإعدادات ← الأمان ← منطقة الخطر («حذف الحساب نهائياً»).',
        'اضغط «حذف الحساب»، ثم أكّد العملية بكتابة كلمة التأكيد المطلوبة.',
        'يُحذف حسابك وكل بياناته فوراً ونهائياً بعد التأكيد. هذه العملية لا يمكن التراجع عنها.',
      ]},
      { h: '3. الحذف عبر مراسلتنا', p: [
        `إن تعذّر عليك الدخول إلى التطبيق، أرسل بريداً إلى ${E.supportEmail} من عنوان البريد المسجّل في حسابك، وعنوانه "طلب حذف حساب".`,
        'سنتحقّق من هويتك وننفّذ الحذف خلال 30 يوماً كحدّ أقصى، ونؤكّد لك ذلك بالبريد.',
      ]},
      { h: '4. البيانات التي تُحذف', p: [
        'كل بيانات حسابك تُحذف نهائياً، وتشمل: ملفّك الشخصي وبيانات الدخول، المشاريع، العمّال، أيام العمل، المصاريف، المقبوضات، الرواتب والسلف، المصالح والبيانات الضريبية، البضاعة، الإشعارات، وسجلّات النشاط — إضافةً إلى حسابات أعضاء الفريق الفرعية التابعة لحسابك.',
      ]},
      { h: '5. البيانات التي قد نحتفظ بها ومدّة الاحتفاظ', p: [
        'سجلّات الفوترة والفواتير: قد يحتفظ بها شريك الدفع Paddle للمدّة التي تفرضها المتطلّبات القانونية والضريبية، بصفته بائع التجزئة المسجّل، حتى بعد حذف حسابك لدينا.',
        'سجلّات الأعطال التقنية (إن وُجدت): تُحذف تلقائياً خلال 90 يوماً.',
        'النسخ الاحتياطية المشفّرة: تُمحى ضمن دورة النسخ الاحتياطي خلال 30 يوماً من الحذف.',
      ]},
      { h: '6. حذف جزء من بياناتك دون حذف الحساب', p: [
        'لست مضطرّاً لحذف حسابك بالكامل لحذف بيانات معيّنة. من داخل التطبيق يمكنك حذف أي سجلّ على حدة في أي وقت — مشروع، عامل، يوم عمل، مصروف، مقبوض، أو دفعة — عبر فتح العنصر واختيار «حذف». تُمحى هذه السجلّات نهائياً ويبقى حسابك وباقي بياناتك كما هي.',
        `أو راسلنا على ${E.supportEmail} محدّداً البيانات التي تريد حذفها، وننفّذ طلبك خلال 30 يوماً.`,
      ]},
      { h: '7. تصدير بياناتك قبل الحذف', p: [
        'قبل الحذف، يمكنك تصدير نسخة كاملة من بياناتك (Excel/PDF) من داخل التطبيق، إذ لا يمكن استرجاعها بعد الحذف.',
      ]},
      { h: '8. التواصل', p: [
        `لأي استفسار حول حذف حسابك أو بياناتك، راسلنا على ${E.supportEmail}.`,
      ]},
    ],
  },
  contact: {
