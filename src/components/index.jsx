...
const TOAST_BOTTOM = 'max(140px, calc(120px + env(safe-area-inset-bottom, 0px)))'
...
export function ErrorToast({ message, onClose }) {
  ...
  return (
    <div className="toast-in" style={{ position: 'fixed', bottom: TOAST_BOTTOM, left: '50%', transform: 'translateX(-50%)', zIndex: 300, maxWidth: 380, width: '90%' }}>
