...
export default function ProjectVaultTab({ project, userId, expenses = [] }) {
  const {
    ...
    addSiteUnit, addSiteUnitsBulk, addSiteUnitsTree, updateSiteUnit, deleteSiteUnit, addDocument, deleteDocument,
  ...
  return (
    <div style={{ direction: 'rtl' }}>
      ...
      {!loading && !error && sub === 'site' && (
        <SiteMapTab units={siteUnits} addSiteUnit={addSiteUnit} addSiteUnitsBulk={addSiteUnitsBulk} addSiteUnitsTree={addSiteUnitsTree} updateSiteUnit={updateSiteUnit} deleteSiteUnit={deleteSiteUnit} />
      )}
